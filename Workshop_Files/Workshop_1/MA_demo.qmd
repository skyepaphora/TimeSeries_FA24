...
subtitle: "Australian Wine Edition <3"
format: pdf
---

In workshop, we will cover the actual high-level ITSMR functions used to implement this kind of smoother. 
...
Are the results "successful?" What would that mean?
