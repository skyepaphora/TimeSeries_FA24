...
#### Inline code
Recall that we generated the variable `x` randomly. We can display those values inline by creating a mini-chunk, which is also capable of dynamic output.

> *The 5th observation in the vector * `x` is `r x[5]`
...
#### Formatting errors
To make sure your markdown syntax doesn't bug out, leave one line of **vertical space** between:
